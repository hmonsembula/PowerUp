...
public class LoadShedding extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		 ...
		 view = inflater.inflate(R.layout.fragment_load_shedding, container, false);
		 ...
		 */
		 ...
		 private OnChildClickListener myListItemClicked =  new OnChildClickListener() {
		  ...
		  public boolean onChildClick(ExpandableListView parent, View v,
		   ...
		   Toast.makeText(view.getContext(), "Clicked on Detail " + headerInfo.getName() 
		 ...
		 private OnGroupClickListener myListGroupClicked =  new OnGroupClickListener() {
		  ...
		  public boolean onGroupClick(ExpandableListView parent, View v,
		   ...
		   HeaderInfo headerInfo = deptList.get(groupPosition);
		   //display it or do something with it
		   Toast.makeText(view.getContext(), "Child on Header " + headerInfo.getName(), 
